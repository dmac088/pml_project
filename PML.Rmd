...
The accuracy on the testing/evaluation data-set is 0.9849, which is extremely high, this model should be good enough for us to pass the final test on the 20 cases.
...
The model resulted in a perfect score of 20/20 for the cases.
