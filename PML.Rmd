...
Now our data should be ready to pass into the train function.
...
We can conclude that there is no loss in model accuracy after retaining only the top 20 predictor variables in the model. The article which this project is based on retains 17 predictors in the model suggesting we could prune the number of features further, however for this exercise this will suffice.

## Test the model

Next we test the model on unseen data (testing dataset) to evaluate the model performance.
...
Finally we test on the 20 cases provided to us for this assignment
